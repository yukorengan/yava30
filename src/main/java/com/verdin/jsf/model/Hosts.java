...
@Table(name = "hosts")
@NamedQueries({
    @NamedQuery(name = "Hosts.findAll", query = "SELECT e FROM Hosts e"),
    @NamedQuery(name = "Hosts.findByHostName", query="SELECT c FROM Hosts c WHERE c.host_name = :host_name")
...
*/
	...
	public int getLast_registration_time() {
		return last_registration_time;
	}
	public void setLast_registration_time(int last_registration_time) {
