...
public class InventoryProperty implements Serializable {
	...
	// static Logger logger = Logger.getLogger(InventoryProperty.class);
...
//			logger.info("getFormattedValue "+ simpleDateFormat.format(value));
	...
	public void setValue(Object value) {
		...
		//logger.info("setValue "+ value.toString());
