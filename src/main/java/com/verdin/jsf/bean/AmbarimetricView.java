...
@Named
@ViewScoped
public class AmbarimetricView implements Serializable {
	...
	static String CLUSTER = "C10H16";// "H2SO4";
	...
	static String DEFAULT_SERVICE = "AMBARI_METRICS";
	...
	public  void init() throws Exception {
		...
		AmbariRestClient _client  =  new AmbariRestClient(HOSTNAME, CLUSTER);
		 ...
		 config = getCurrentConfigurationByType("ams-site");
