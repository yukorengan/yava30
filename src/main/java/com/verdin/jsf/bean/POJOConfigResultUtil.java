...
public class POJOConfigResultUtil {
	
	static Logger logger = Logger.getLogger(POJOConfigResultUtil.class);

	  public static POJOConfigResult json2pojo(String json) throws Exception {
		  
		  
		  POJOConfigResult  _hbase =  new POJOConfigResult();
