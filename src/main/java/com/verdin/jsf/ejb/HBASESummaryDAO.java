...
import com.verdin.jsf.model.HBASESummary;
...
@Named("hbaseSumService")
@ApplicationScoped
public class HBASESummaryDAO {
	
	static Logger logger = Logger.getLogger(HBASESummary.class);
	
	public HBASESummary getHBASESummary() throws Exception {

		logger.info("get in DAO ...");

		HBASESummary m = new HBASESummary();
		String json = null;

		try {

			String url = "http://192.168.3.132:8080/api/v1/clusters/C10H16/services/HBASE/";
