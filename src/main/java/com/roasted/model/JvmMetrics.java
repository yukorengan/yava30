...
public JvmMetrics(String name, String modelerType, String tagContext, String tagProcessName, Object tagSessionId, String tagHostname, Double memNonHeapUsedM, Double memNonHeapCommittedM, Double memNonHeapMaxM, Double memHeapUsedM, Double memHeapCommittedM, Double memHeapMaxM, Double memMaxM, Integer gcCountParNew, Integer gcTimeMillisParNew, Integer gcCountConcurrentMarkSweep, Integer gcTimeMillisConcurrentMarkSweep, Integer gcCount, Integer gcTimeMillis, Integer gcNumWarnThresholdExceeded, Integer gcNumInfoThresholdExceeded, Integer gcTotalExtraSleepTime, Integer threadsNew, Integer threadsRunnable, Integer threadsBlocked, Integer threadsWaiting, Integer threadsTimedWaiting, Integer threadsTerminated, Integer logFatal, Integer logError, Integer logWarn, Integer logInfo) {
super();
this.name = name;
