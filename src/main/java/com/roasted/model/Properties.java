...
public class Properties {
    ...
    private String rangerPluginHbaseAmbariClusterName;
    ...
    private String externalAdminPassword;
    private String externalAdminUsername;
    private String externalRangerAdminPassword;
    private String externalRangerAdminUsername;
    private String policyUser;
    private String rangerHbasePluginEnabled;
    ...
    private String rangerPluginHbasePolicyCacheDir;
    private String rangerPluginHbasePolicyPollIntervalMs;
    private String rangerPluginHbasePolicyRestSslConfigFile;
    private String rangerPluginHbasePolicyRestUrl;
    private String rangerPluginHbasePolicySourceImpl;
    private String rangerPluginHbaseServiceName;
    private String xasecureHbaseUpdateXapoliciesOnGrantRevoke;
    private String hbaseBackupEnable;
    private String hbaseMasterLogcleanerPlugins;
    private String hbaseProcedureMasterClasses;
    private String hbaseProcedureRegionserverClasses;
    ...
    public String getRangerPluginHbaseAmbariClusterName() {
        return rangerPluginHbaseAmbariClusterName;
    }

    public void setRangerPluginHbaseAmbariClusterName(String rangerPluginHbaseAmbariClusterName) {
        this.rangerPluginHbaseAmbariClusterName = rangerPluginHbaseAmbariClusterName;
    }
    ...
    public String getExternalAdminPassword() {
        return externalAdminPassword;
    }

    public void setExternalAdminPassword(String externalAdminPassword) {
        this.externalAdminPassword = externalAdminPassword;
    }
    ...
    public String getExternalRangerAdminPassword() {
        return externalRangerAdminPassword;
    }

    public void setExternalRangerAdminPassword(String externalRangerAdminPassword) {
        this.externalRangerAdminPassword = externalRangerAdminPassword;
    }

    public String getExternalRangerAdminUsername() {
        return externalRangerAdminUsername;
    }

    public void setExternalRangerAdminUsername(String externalRangerAdminUsername) {
        this.externalRangerAdminUsername = externalRangerAdminUsername;
    }
    ...
    public String getRangerHbasePluginEnabled() {
        return rangerHbasePluginEnabled;
    }

    public void setRangerHbasePluginEnabled(String rangerHbasePluginEnabled) {
        this.rangerHbasePluginEnabled = rangerHbasePluginEnabled;
    }
    ...
    public String getRangerPluginHbasePolicyCacheDir() {
        return rangerPluginHbasePolicyCacheDir;
    }

    public void setRangerPluginHbasePolicyCacheDir(String rangerPluginHbasePolicyCacheDir) {
        this.rangerPluginHbasePolicyCacheDir = rangerPluginHbasePolicyCacheDir;
    }

    public String getRangerPluginHbasePolicyPollIntervalMs() {
        return rangerPluginHbasePolicyPollIntervalMs;
    }

    public void setRangerPluginHbasePolicyPollIntervalMs(String rangerPluginHbasePolicyPollIntervalMs) {
        this.rangerPluginHbasePolicyPollIntervalMs = rangerPluginHbasePolicyPollIntervalMs;
    }

    public String getRangerPluginHbasePolicyRestSslConfigFile() {
        return rangerPluginHbasePolicyRestSslConfigFile;
    }

    public void setRangerPluginHbasePolicyRestSslConfigFile(String rangerPluginHbasePolicyRestSslConfigFile) {
        this.rangerPluginHbasePolicyRestSslConfigFile = rangerPluginHbasePolicyRestSslConfigFile;
    }

    public String getRangerPluginHbasePolicyRestUrl() {
        return rangerPluginHbasePolicyRestUrl;
    }

    public void setRangerPluginHbasePolicyRestUrl(String rangerPluginHbasePolicyRestUrl) {
        this.rangerPluginHbasePolicyRestUrl = rangerPluginHbasePolicyRestUrl;
    }

    public String getRangerPluginHbasePolicySourceImpl() {
        return rangerPluginHbasePolicySourceImpl;
    }

    public void setRangerPluginHbasePolicySourceImpl(String rangerPluginHbasePolicySourceImpl) {
        this.rangerPluginHbasePolicySourceImpl = rangerPluginHbasePolicySourceImpl;
    }

    public String getRangerPluginHbaseServiceName() {
        return rangerPluginHbaseServiceName;
    }

    public void setRangerPluginHbaseServiceName(String rangerPluginHbaseServiceName) {
        this.rangerPluginHbaseServiceName = rangerPluginHbaseServiceName;
    }

    public String getXasecureHbaseUpdateXapoliciesOnGrantRevoke() {
        return xasecureHbaseUpdateXapoliciesOnGrantRevoke;
    }

    public void setXasecureHbaseUpdateXapoliciesOnGrantRevoke(String xasecureHbaseUpdateXapoliciesOnGrantRevoke) {
        this.xasecureHbaseUpdateXapoliciesOnGrantRevoke = xasecureHbaseUpdateXapoliciesOnGrantRevoke;
    }

    public String getHbaseBackupEnable() {
        return hbaseBackupEnable;
    }

    public void setHbaseBackupEnable(String hbaseBackupEnable) {
        this.hbaseBackupEnable = hbaseBackupEnable;
    }

    public String getHbaseMasterLogcleanerPlugins() {
        return hbaseMasterLogcleanerPlugins;
    }

    public void setHbaseMasterLogcleanerPlugins(String hbaseMasterLogcleanerPlugins) {
        this.hbaseMasterLogcleanerPlugins = hbaseMasterLogcleanerPlugins;
    }

    public String getHbaseProcedureMasterClasses() {
        return hbaseProcedureMasterClasses;
    }

    public void setHbaseProcedureMasterClasses(String hbaseProcedureMasterClasses) {
        this.hbaseProcedureMasterClasses = hbaseProcedureMasterClasses;
    }

    public String getHbaseProcedureRegionserverClasses() {
        return hbaseProcedureRegionserverClasses;
    }

    public void setHbaseProcedureRegionserverClasses(String hbaseProcedureRegionserverClasses) {
        this.hbaseProcedureRegionserverClasses = hbaseProcedureRegionserverClasses;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("rangerPluginHbaseAmbariClusterName");
        sb.append('=');
        sb.append(((this.rangerPluginHbaseAmbariClusterName == null)?"<null>":this.rangerPluginHbaseAmbariClusterName));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("externalAdminPassword");
        sb.append('=');
        sb.append(((this.externalAdminPassword == null)?"<null>":this.externalAdminPassword));
        sb.append(',');
        sb.append("externalAdminUsername");
        sb.append('=');
        sb.append(((this.externalAdminUsername == null)?"<null>":this.externalAdminUsername));
        sb.append(',');
        sb.append("externalRangerAdminPassword");
        sb.append('=');
        sb.append(((this.externalRangerAdminPassword == null)?"<null>":this.externalRangerAdminPassword));
        sb.append(',');
        sb.append("externalRangerAdminUsername");
        sb.append('=');
        sb.append(((this.externalRangerAdminUsername == null)?"<null>":this.externalRangerAdminUsername));
        sb.append(',');
        sb.append("policyUser");
        sb.append('=');
        sb.append(((this.policyUser == null)?"<null>":this.policyUser));
        sb.append(',');
        sb.append("rangerHbasePluginEnabled");
        sb.append('=');
        sb.append(((this.rangerHbasePluginEnabled == null)?"<null>":this.rangerHbasePluginEnabled));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rangerPluginHbasePolicyCacheDir");
        sb.append('=');
        sb.append(((this.rangerPluginHbasePolicyCacheDir == null)?"<null>":this.rangerPluginHbasePolicyCacheDir));
        sb.append(',');
        sb.append("rangerPluginHbasePolicyPollIntervalMs");
        sb.append('=');
        sb.append(((this.rangerPluginHbasePolicyPollIntervalMs == null)?"<null>":this.rangerPluginHbasePolicyPollIntervalMs));
        sb.append(',');
        sb.append("rangerPluginHbasePolicyRestSslConfigFile");
        sb.append('=');
        sb.append(((this.rangerPluginHbasePolicyRestSslConfigFile == null)?"<null>":this.rangerPluginHbasePolicyRestSslConfigFile));
        sb.append(',');
        sb.append("rangerPluginHbasePolicyRestUrl");
        sb.append('=');
        sb.append(((this.rangerPluginHbasePolicyRestUrl == null)?"<null>":this.rangerPluginHbasePolicyRestUrl));
        sb.append(',');
        sb.append("rangerPluginHbasePolicySourceImpl");
        sb.append('=');
        sb.append(((this.rangerPluginHbasePolicySourceImpl == null)?"<null>":this.rangerPluginHbasePolicySourceImpl));
        sb.append(',');
        sb.append("rangerPluginHbaseServiceName");
        sb.append('=');
        sb.append(((this.rangerPluginHbaseServiceName == null)?"<null>":this.rangerPluginHbaseServiceName));
        sb.append(',');
        sb.append("xasecureHbaseUpdateXapoliciesOnGrantRevoke");
        sb.append('=');
        sb.append(((this.xasecureHbaseUpdateXapoliciesOnGrantRevoke == null)?"<null>":this.xasecureHbaseUpdateXapoliciesOnGrantRevoke));
        sb.append(',');
        sb.append("hbaseBackupEnable");
        sb.append('=');
        sb.append(((this.hbaseBackupEnable == null)?"<null>":this.hbaseBackupEnable));
        sb.append(',');
        sb.append("hbaseMasterLogcleanerPlugins");
        sb.append('=');
        sb.append(((this.hbaseMasterLogcleanerPlugins == null)?"<null>":this.hbaseMasterLogcleanerPlugins));
        sb.append(',');
        sb.append("hbaseProcedureMasterClasses");
        sb.append('=');
        sb.append(((this.hbaseProcedureMasterClasses == null)?"<null>":this.hbaseProcedureMasterClasses));
        sb.append(',');
        sb.append("hbaseProcedureRegionserverClasses");
        sb.append('=');
        sb.append(((this.hbaseProcedureRegionserverClasses == null)?"<null>":this.hbaseProcedureRegionserverClasses));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.externalAdminPassword == null)? 0 :this.externalAdminPassword.hashCode()));
        result = ((result* 31)+((this.rangerPluginHbasePolicySourceImpl == null)? 0 :this.rangerPluginHbasePolicySourceImpl.hashCode()));
        ...
        result = ((result* 31)+((this.rangerPluginHbaseAmbariClusterName == null)? 0 :this.rangerPluginHbaseAmbariClusterName.hashCode()));
        ...
        result = ((result* 31)+((this.rangerPluginHbaseServiceName == null)? 0 :this.rangerPluginHbaseServiceName.hashCode()));
        ...
        result = ((result* 31)+((this.rangerHbasePluginEnabled == null)? 0 :this.rangerHbasePluginEnabled.hashCode()));
        ...
        result = ((result* 31)+((this.externalRangerAdminUsername == null)? 0 :this.externalRangerAdminUsername.hashCode()));
        result = ((result* 31)+((this.rangerPluginHbasePolicyRestUrl == null)? 0 :this.rangerPluginHbasePolicyRestUrl.hashCode()));
        result = ((result* 31)+((this.rangerPluginHbasePolicyRestSslConfigFile == null)? 0 :this.rangerPluginHbasePolicyRestSslConfigFile.hashCode()));
        ...
        result = ((result* 31)+((this.hbaseMasterLogcleanerPlugins == null)? 0 :this.hbaseMasterLogcleanerPlugins.hashCode()));
        ...
        result = ((result* 31)+((this.hbaseProcedureMasterClasses == null)? 0 :this.hbaseProcedureMasterClasses.hashCode()));
        ...
        result = ((result* 31)+((this.hbaseProcedureRegionserverClasses == null)? 0 :this.hbaseProcedureRegionserverClasses.hashCode()));
        ...
        result = ((result* 31)+((this.externalRangerAdminPassword == null)? 0 :this.externalRangerAdminPassword.hashCode()));
        ...
        result = ((result* 31)+((this.externalAdminUsername == null)? 0 :this.externalAdminUsername.hashCode()));
        ...
        result = ((result* 31)+((this.rangerPluginHbasePolicyCacheDir == null)? 0 :this.rangerPluginHbasePolicyCacheDir.hashCode()));
        ...
        result = ((result* 31)+((this.xasecureHbaseUpdateXapoliciesOnGrantRevoke == null)? 0 :this.xasecureHbaseUpdateXapoliciesOnGrantRevoke.hashCode()));
        ...
        result = ((result* 31)+((this.rangerPluginHbasePolicyPollIntervalMs == null)? 0 :this.rangerPluginHbasePolicyPollIntervalMs.hashCode()));
        ...
        result = ((result* 31)+((this.hbaseBackupEnable == null)? 0 :this.hbaseBackupEnable.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((this.hbaseZookeeperQuorum == rhs.hbaseZookeeperQuorum)||((this.hbaseZookeeperQuorum!= null)&&this.hbaseZookeeperQuorum.equals(rhs.hbaseZookeeperQuorum)))&&((this.xasecurePolicymgrClientsslTruststorePassword == rhs.xasecurePolicymgrClientsslTruststorePassword)||((this.xasecurePolicymgrClientsslTruststorePassword!= null)&&this.xasecurePolicymgrClientsslTruststorePassword.equals(rhs.xasecurePolicymgrClientsslTruststorePassword))))&&((this.securityAdminProtocolAcl == rhs.securityAdminProtocolAcl)||((this.securityAdminProtocolAcl!= null)&&this.securityAdminProtocolAcl.equals(rhs.securityAdminProtocolAcl))))&&((this.externalAdminPassword == rhs.externalAdminPassword)||((this.externalAdminPassword!= null)&&this.externalAdminPassword.equals(rhs.externalAdminPassword))))&&((this.rangerPluginHbasePolicySourceImpl == rhs.rangerPluginHbasePolicySourceImpl)||((this.rangerPluginHbasePolicySourceImpl!= null)&&this.rangerPluginHbasePolicySourceImpl.equals(rhs.rangerPluginHbasePolicySourceImpl))))&&((this.atlasHookHbaseSynchronous == rhs.atlasHookHbaseSynchronous)||((this.atlasHookHbaseSynchronous!= null)&&this.atlasHookHbaseSynchronous.equals(rhs.atlasHookHbaseSynchronous))))&&((this.xasecureAuditDestinationHdfsBatchFilespoolDir == rhs.xasecureAuditDestinationHdfsBatchFilespoolDir)||((this.xasecureAuditDestinationHdfsBatchFilespoolDir!= null)&&this.xasecureAuditDestinationHdfsBatchFilespoolDir.equals(rhs.xasecureAuditDestinationHdfsBatchFilespoolDir))))&&((this.rangerPluginHbaseAmbariClusterName == rhs.rangerPluginHbaseAmbariClusterName)||((this.rangerPluginHbaseAmbariClusterName!= null)&&this.rangerPluginHbaseAmbariClusterName.equals(rhs.rangerPluginHbaseAmbariClusterName))))&&((this.xasecurePolicymgrClientsslKeystoreCredentialFile == rhs.xasecurePolicymgrClientsslKeystoreCredentialFile)||((this.xasecurePolicymgrClientsslKeystoreCredentialFile!= null)&&this.xasecurePolicymgrClientsslKeystoreCredentialFile.equals(rhs.xasecurePolicymgrClientsslKeystoreCredentialFile))))&&((this.hbaseLogMaxfilesize == rhs.hbaseLogMaxfilesize)||((this.hbaseLogMaxfilesize!= null)&&this.hbaseLogMaxfilesize.equals(rhs.hbaseLogMaxfilesize))))&&((this.hbaseSecurityLogMaxbackupindex == rhs.hbaseSecurityLogMaxbackupindex)||((this.hbaseSecurityLogMaxbackupindex!= null)&&this.hbaseSecurityLogMaxbackupindex.equals(rhs.hbaseSecurityLogMaxbackupindex))))&&((this.hbaseHregionMajorcompaction == rhs.hbaseHregionMajorcompaction)||((this.hbaseHregionMajorcompaction!= null)&&this.hbaseHregionMajorcompaction.equals(rhs.hbaseHregionMajorcompaction))))&&((this.xasecureAuditIsEnabled == rhs.xasecureAuditIsEnabled)||((this.xasecureAuditIsEnabled!= null)&&this.xasecureAuditIsEnabled.equals(rhs.xasecureAuditIsEnabled))))&&((this.rangerPluginHbaseServiceName == rhs.rangerPluginHbaseServiceName)||((this.rangerPluginHbaseServiceName!= null)&&this.rangerPluginHbaseServiceName.equals(rhs.rangerPluginHbaseServiceName))))&&((this.hbaseRegionserverWalCodec == rhs.hbaseRegionserverWalCodec)||((this.hbaseRegionserverWalCodec!= null)&&this.hbaseRegionserverWalCodec.equals(rhs.hbaseRegionserverWalCodec))))&&((this.hbaseRegionserverXmnRatio == rhs.hbaseRegionserverXmnRatio)||((this.hbaseRegionserverXmnRatio!= null)&&this.hbaseRegionserverXmnRatio.equals(rhs.hbaseRegionserverXmnRatio))))&&((this.rangerHbasePluginEnabled == rhs.rangerHbasePluginEnabled)||((this.rangerHbasePluginEnabled!= null)&&this.rangerHbasePluginEnabled.equals(rhs.rangerHbasePluginEnabled))))&&((this.hbaseZookeeperPropertyClientPort == rhs.hbaseZookeeperPropertyClientPort)||((this.hbaseZookeeperPropertyClientPort!= null)&&this.hbaseZookeeperPropertyClientPort.equals(rhs.hbaseZookeeperPropertyClientPort))))&&((this.hbaseHregionMemstoreFlushSize == rhs.hbaseHregionMemstoreFlushSize)||((this.hbaseHregionMemstoreFlushSize!= null)&&this.hbaseHregionMemstoreFlushSize.equals(rhs.hbaseHregionMemstoreFlushSize))))&&((this.repositoryConfigUsername == rhs.repositoryConfigUsername)||((this.repositoryConfigUsername!= null)&&this.repositoryConfigUsername.equals(rhs.repositoryConfigUsername))))&&((this.externalRangerAdminUsername == rhs.externalRangerAdminUsername)||((this.externalRangerAdminUsername!= null)&&this.externalRangerAdminUsername.equals(rhs.externalRangerAdminUsername))))&&((this.rangerPluginHbasePolicyRestUrl == rhs.rangerPluginHbasePolicyRestUrl)||((this.rangerPluginHbasePolicyRestUrl!= null)&&this.rangerPluginHbasePolicyRestUrl.equals(rhs.rangerPluginHbasePolicyRestUrl))))&&((this.rangerPluginHbasePolicyRestSslConfigFile == rhs.rangerPluginHbasePolicyRestSslConfigFile)||((this.rangerPluginHbasePolicyRestSslConfigFile!= null)&&this.rangerPluginHbasePolicyRestSslConfigFile.equals(rhs.rangerPluginHbasePolicyRestSslConfigFile))))&&((this.hbaseZookeeperUseMulti == rhs.hbaseZookeeperUseMulti)||((this.hbaseZookeeperUseMulti!= null)&&this.hbaseZookeeperUseMulti.equals(rhs.hbaseZookeeperUseMulti))))&&((this.hbaseSecurityAuthentication == rhs.hbaseSecurityAuthentication)||((this.hbaseSecurityAuthentication!= null)&&this.hbaseSecurityAuthentication.equals(rhs.hbaseSecurityAuthentication))))&&((this.hbaseSecurityAuthorization == rhs.hbaseSecurityAuthorization)||((this.hbaseSecurityAuthorization!= null)&&this.hbaseSecurityAuthorization.equals(rhs.hbaseSecurityAuthorization))))&&((this.hbaseMasterLogcleanerPlugins == rhs.hbaseMasterLogcleanerPlugins)||((this.hbaseMasterLogcleanerPlugins!= null)&&this.hbaseMasterLogcleanerPlugins.equals(rhs.hbaseMasterLogcleanerPlugins))))&&((this.hbaseHstoreCompactionMax == rhs.hbaseHstoreCompactionMax)||((this.hbaseHstoreCompactionMax!= null)&&this.hbaseHstoreCompactionMax.equals(rhs.hbaseHstoreCompactionMax))))&&((this.xasecureAuditProviderSummaryEnabled == rhs.xasecureAuditProviderSummaryEnabled)||((this.xasecureAuditProviderSummaryEnabled!= null)&&this.xasecureAuditProviderSummaryEnabled.equals(rhs.xasecureAuditProviderSummaryEnabled))))&&((this.hbaseClientRetriesNumber == rhs.hbaseClientRetriesNumber)||((this.hbaseClientRetriesNumber!= null)&&this.hbaseClientRetriesNumber.equals(rhs.hbaseClientRetriesNumber))))&&((this.hbaseMasterInfoBindAddress == rhs.hbaseMasterInfoBindAddress)||((this.hbaseMasterInfoBindAddress!= null)&&this.hbaseMasterInfoBindAddress.equals(rhs.hbaseMasterInfoBindAddress))))&&((this.hbaseJavaIoTmpdir == rhs.hbaseJavaIoTmpdir)||((this.hbaseJavaIoTmpdir!= null)&&this.hbaseJavaIoTmpdir.equals(rhs.hbaseJavaIoTmpdir))))&&((this.hbaseRpcControllerfactoryClass == rhs.hbaseRpcControllerfactoryClass)||((this.hbaseRpcControllerfactoryClass!= null)&&this.hbaseRpcControllerfactoryClass.equals(rhs.hbaseRpcControllerfactoryClass))))&&((this.hbaseRegionserverExecutorOpenregionThreads == rhs.hbaseRegionserverExecutorOpenregionThreads)||((this.hbaseRegionserverExecutorOpenregionThreads!= null)&&this.hbaseRegionserverExecutorOpenregionThreads.equals(rhs.hbaseRegionserverExecutorOpenregionThreads))))&&((this.hbaseRegionserverInfoPort == rhs.hbaseRegionserverInfoPort)||((this.hbaseRegionserverInfoPort!= null)&&this.hbaseRegionserverInfoPort.equals(rhs.hbaseRegionserverInfoPort))))&&((this.hbaseRegionserverPort == rhs.hbaseRegionserverPort)||((this.hbaseRegionserverPort!= null)&&this.hbaseRegionserverPort.equals(rhs.hbaseRegionserverPort))))&&((this.hbaseMasterInfoPort == rhs.hbaseMasterInfoPort)||((this.hbaseMasterInfoPort!= null)&&this.hbaseMasterInfoPort.equals(rhs.hbaseMasterInfoPort))))&&((this.phoenixSqlEnabled == rhs.phoenixSqlEnabled)||((this.phoenixSqlEnabled!= null)&&this.phoenixSqlEnabled.equals(rhs.phoenixSqlEnabled))))&&((this.hbaseClientScannerCaching == rhs.hbaseClientScannerCaching)||((this.hbaseClientScannerCaching!= null)&&this.hbaseClientScannerCaching.equals(rhs.hbaseClientScannerCaching))))&&((this.xasecureAuditDestinationSolrBatchFilespoolDir == rhs.xasecureAuditDestinationSolrBatchFilespoolDir)||((this.xasecureAuditDestinationSolrBatchFilespoolDir!= null)&&this.xasecureAuditDestinationSolrBatchFilespoolDir.equals(rhs.xasecureAuditDestinationSolrBatchFilespoolDir))))&&((this.hbaseProcedureMasterClasses == rhs.hbaseProcedureMasterClasses)||((this.hbaseProcedureMasterClasses!= null)&&this.hbaseProcedureMasterClasses.equals(rhs.hbaseProcedureMasterClasses))))&&((this.xasecureAuditDestinationSolrZookeepers == rhs.xasecureAuditDestinationSolrZookeepers)||((this.xasecureAuditDestinationSolrZookeepers!= null)&&this.xasecureAuditDestinationSolrZookeepers.equals(rhs.xasecureAuditDestinationSolrZookeepers))))&&((this.hbaseCoprocessorMasterClasses == rhs.hbaseCoprocessorMasterClasses)||((this.hbaseCoprocessorMasterClasses!= null)&&this.hbaseCoprocessorMasterClasses.equals(rhs.hbaseCoprocessorMasterClasses))))&&((this.hbaseRootdir == rhs.hbaseRootdir)||((this.hbaseRootdir!= null)&&this.hbaseRootdir.equals(rhs.hbaseRootdir))))&&((this.hbaseBulkloadStagingDir == rhs.hbaseBulkloadStagingDir)||((this.hbaseBulkloadStagingDir!= null)&&this.hbaseBulkloadStagingDir.equals(rhs.hbaseBulkloadStagingDir))))&&((this.hbaseProcedureRegionserverClasses == rhs.hbaseProcedureRegionserverClasses)||((this.hbaseProcedureRegionserverClasses!= null)&&this.hbaseProcedureRegionserverClasses.equals(rhs.hbaseProcedureRegionserverClasses))))&&((this.hbaseLocalDir == rhs.hbaseLocalDir)||((this.hbaseLocalDir!= null)&&this.hbaseLocalDir.equals(rhs.hbaseLocalDir))))&&((this.atlasHookHbaseMinThreads == rhs.atlasHookHbaseMinThreads)||((this.atlasHookHbaseMinThreads!= null)&&this.atlasHookHbaseMinThreads.equals(rhs.atlasHookHbaseMinThreads))))&&((this.hbaseSuperuser == rhs.hbaseSuperuser)||((this.hbaseSuperuser!= null)&&this.hbaseSuperuser.equals(rhs.hbaseSuperuser))))&&((this.hbaseHregionMaxFilesize == rhs.hbaseHregionMaxFilesize)||((this.hbaseHregionMaxFilesize!= null)&&this.hbaseHregionMaxFilesize.equals(rhs.hbaseHregionMaxFilesize))))&&((this.hbaseRegionServerRpcSchedulerFactoryClass == rhs.hbaseRegionServerRpcSchedulerFactoryClass)||((this.hbaseRegionServerRpcSchedulerFactoryClass!= null)&&this.hbaseRegionServerRpcSchedulerFactoryClass.equals(rhs.hbaseRegionServerRpcSchedulerFactoryClass))))&&((this.hbaseHregionMemstoreMslabEnabled == rhs.hbaseHregionMemstoreMslabEnabled)||((this.hbaseHregionMemstoreMslabEnabled!= null)&&this.hbaseHregionMemstoreMslabEnabled.equals(rhs.hbaseHregionMemstoreMslabEnabled))))&&((this.hbaseHstoreBlockingStoreFiles == rhs.hbaseHstoreBlockingStoreFiles)||((this.hbaseHstoreBlockingStoreFiles!= null)&&this.hbaseHstoreBlockingStoreFiles.equals(rhs.hbaseHstoreBlockingStoreFiles))))&&((this.hbaseHstoreCompactionThreshold == rhs.hbaseHstoreCompactionThreshold)||((this.hbaseHstoreCompactionThreshold!= null)&&this.hbaseHstoreCompactionThreshold.equals(rhs.hbaseHstoreCompactionThreshold))))&&((this.hbaseRegionserverHandlerCount == rhs.hbaseRegionserverHandlerCount)||((this.hbaseRegionserverHandlerCount!= null)&&this.hbaseRegionserverHandlerCount.equals(rhs.hbaseRegionserverHandlerCount))))&&((this.repositoryConfigPassword == rhs.repositoryConfigPassword)||((this.repositoryConfigPassword!= null)&&this.repositoryConfigPassword.equals(rhs.repositoryConfigPassword))))&&((this.hbaseUser == rhs.hbaseUser)||((this.hbaseUser!= null)&&this.hbaseUser.equals(rhs.hbaseUser))))&&((this.phoenixQueryTimeoutMs == rhs.phoenixQueryTimeoutMs)||((this.phoenixQueryTimeoutMs!= null)&&this.phoenixQueryTimeoutMs.equals(rhs.phoenixQueryTimeoutMs))))&&((this.externalRangerAdminPassword == rhs.externalRangerAdminPassword)||((this.externalRangerAdminPassword!= null)&&this.externalRangerAdminPassword.equals(rhs.externalRangerAdminPassword))))&&((this.hbaseMasterUiReadonly == rhs.hbaseMasterUiReadonly)||((this.hbaseMasterUiReadonly!= null)&&this.hbaseMasterUiReadonly.equals(rhs.hbaseMasterUiReadonly))))&&((this.xasecurePolicymgrClientsslKeystore == rhs.xasecurePolicymgrClientsslKeystore)||((this.xasecurePolicymgrClientsslKeystore!= null)&&this.xasecurePolicymgrClientsslKeystore.equals(rhs.xasecurePolicymgrClientsslKeystore))))&&((this.xasecurePolicymgrClientsslTruststoreCredentialFile == rhs.xasecurePolicymgrClientsslTruststoreCredentialFile)||((this.xasecurePolicymgrClientsslTruststoreCredentialFile!= null)&&this.xasecurePolicymgrClientsslTruststoreCredentialFile.equals(rhs.xasecurePolicymgrClientsslTruststoreCredentialFile))))&&((this.hbaseCoprocessorRegionClasses == rhs.hbaseCoprocessorRegionClasses)||((this.hbaseCoprocessorRegionClasses!= null)&&this.hbaseCoprocessorRegionClasses.equals(rhs.hbaseCoprocessorRegionClasses))))&&((this.xasecureAuditDestinationHdfs == rhs.xasecureAuditDestinationHdfs)||((this.xasecureAuditDestinationHdfs!= null)&&this.xasecureAuditDestinationHdfs.equals(rhs.xasecureAuditDestinationHdfs))))&&((this.commonNameForCertificate == rhs.commonNameForCertificate)||((this.commonNameForCertificate!= null)&&this.commonNameForCertificate.equals(rhs.commonNameForCertificate))))&&((this.hbaseClientKeyvalueMaxsize == rhs.hbaseClientKeyvalueMaxsize)||((this.hbaseClientKeyvalueMaxsize!= null)&&this.hbaseClientKeyvalueMaxsize.equals(rhs.hbaseClientKeyvalueMaxsize))))&&((this.hbaseRegionserverHeapsize == rhs.hbaseRegionserverHeapsize)||((this.hbaseRegionserverHeapsize!= null)&&this.hbaseRegionserverHeapsize.equals(rhs.hbaseRegionserverHeapsize))))&&((this.hbaseSecurityLogMaxfilesize == rhs.hbaseSecurityLogMaxfilesize)||((this.hbaseSecurityLogMaxfilesize!= null)&&this.hbaseSecurityLogMaxfilesize.equals(rhs.hbaseSecurityLogMaxfilesize))))&&((this.hbaseRegionserverXmnMax == rhs.hbaseRegionserverXmnMax)||((this.hbaseRegionserverXmnMax!= null)&&this.hbaseRegionserverXmnMax.equals(rhs.hbaseRegionserverXmnMax))))&&((this.externalAdminUsername == rhs.externalAdminUsername)||((this.externalAdminUsername!= null)&&this.externalAdminUsername.equals(rhs.externalAdminUsername))))&&((this.xasecurePolicymgrClientsslKeystorePassword == rhs.xasecurePolicymgrClientsslKeystorePassword)||((this.xasecurePolicymgrClientsslKeystorePassword!= null)&&this.xasecurePolicymgrClientsslKeystorePassword.equals(rhs.xasecurePolicymgrClientsslKeystorePassword))))&&((this.dfsDomainSocketPath == rhs.dfsDomainSocketPath)||((this.dfsDomainSocketPath!= null)&&this.dfsDomainSocketPath.equals(rhs.dfsDomainSocketPath))))&&((this.hbaseLogDir == rhs.hbaseLogDir)||((this.hbaseLogDir!= null)&&this.hbaseLogDir.equals(rhs.hbaseLogDir))))&&((this.rangerPluginHbasePolicyCacheDir == rhs.rangerPluginHbasePolicyCacheDir)||((this.rangerPluginHbasePolicyCacheDir!= null)&&this.rangerPluginHbasePolicyCacheDir.equals(rhs.rangerPluginHbasePolicyCacheDir))))&&((this.zookeeperRecoveryRetry == rhs.zookeeperRecoveryRetry)||((this.zookeeperRecoveryRetry!= null)&&this.zookeeperRecoveryRetry.equals(rhs.zookeeperRecoveryRetry))))&&((this.xasecureAuditDestinationSolr == rhs.xasecureAuditDestinationSolr)||((this.xasecureAuditDestinationSolr!= null)&&this.xasecureAuditDestinationSolr.equals(rhs.xasecureAuditDestinationSolr))))&&((this.hfileBlockCacheSize == rhs.hfileBlockCacheSize)||((this.hfileBlockCacheSize!= null)&&this.hfileBlockCacheSize.equals(rhs.hfileBlockCacheSize))))&&((this.xasecureHbaseUpdateXapoliciesOnGrantRevoke == rhs.xasecureHbaseUpdateXapoliciesOnGrantRevoke)||((this.xasecureHbaseUpdateXapoliciesOnGrantRevoke!= null)&&this.xasecureHbaseUpdateXapoliciesOnGrantRevoke.equals(rhs.xasecureHbaseUpdateXapoliciesOnGrantRevoke))))&&((this.atlasHookHbaseKeepAliveTime == rhs.atlasHookHbaseKeepAliveTime)||((this.atlasHookHbaseKeepAliveTime!= null)&&this.atlasHookHbaseKeepAliveTime.equals(rhs.atlasHookHbaseKeepAliveTime))))&&((this.hbaseUserNprocLimit == rhs.hbaseUserNprocLimit)||((this.hbaseUserNprocLimit!= null)&&this.hbaseUserNprocLimit.equals(rhs.hbaseUserNprocLimit))))&&((this.atlasHookHbaseNumRetries == rhs.atlasHookHbaseNumRetries)||((this.atlasHookHbaseNumRetries!= null)&&this.atlasHookHbaseNumRetries.equals(rhs.atlasHookHbaseNumRetries))))&&((this.xasecureAuditDestinationSolrUrls == rhs.xasecureAuditDestinationSolrUrls)||((this.xasecureAuditDestinationSolrUrls!= null)&&this.xasecureAuditDestinationSolrUrls.equals(rhs.xasecureAuditDestinationSolrUrls))))&&((this.rangerPluginHbasePolicyPollIntervalMs == rhs.rangerPluginHbasePolicyPollIntervalMs)||((this.rangerPluginHbasePolicyPollIntervalMs!= null)&&this.rangerPluginHbasePolicyPollIntervalMs.equals(rhs.rangerPluginHbasePolicyPollIntervalMs))))&&((this.hbaseLogMaxbackupindex == rhs.hbaseLogMaxbackupindex)||((this.hbaseLogMaxbackupindex!= null)&&this.hbaseLogMaxbackupindex.equals(rhs.hbaseLogMaxbackupindex))))&&((this.hbaseRpcProtection == rhs.hbaseRpcProtection)||((this.hbaseRpcProtection!= null)&&this.hbaseRpcProtection.equals(rhs.hbaseRpcProtection))))&&((this.content == rhs.content)||((this.content!= null)&&this.content.equals(rhs.content))))&&((this.hbaseMasterWaitOnRegionserversTimeout == rhs.hbaseMasterWaitOnRegionserversTimeout)||((this.hbaseMasterWaitOnRegionserversTimeout!= null)&&this.hbaseMasterWaitOnRegionserversTimeout.equals(rhs.hbaseMasterWaitOnRegionserversTimeout))))&&((this.zookeeperSessionTimeout == rhs.zookeeperSessionTimeout)||((this.zookeeperSessionTimeout!= null)&&this.zookeeperSessionTimeout.equals(rhs.zookeeperSessionTimeout))))&&((this.hbaseRegionserverShutdownTimeout == rhs.hbaseRegionserverShutdownTimeout)||((this.hbaseRegionserverShutdownTimeout!= null)&&this.hbaseRegionserverShutdownTimeout.equals(rhs.hbaseRegionserverShutdownTimeout))))&&((this.hbaseMasterNamespaceInitTimeout == rhs.hbaseMasterNamespaceInitTimeout)||((this.hbaseMasterNamespaceInitTimeout!= null)&&this.hbaseMasterNamespaceInitTimeout.equals(rhs.hbaseMasterNamespaceInitTimeout))))&&((this.xasecurePolicymgrClientsslTruststore == rhs.xasecurePolicymgrClientsslTruststore)||((this.xasecurePolicymgrClientsslTruststore!= null)&&this.xasecurePolicymgrClientsslTruststore.equals(rhs.xasecurePolicymgrClientsslTruststore))))&&((this.atlasHookHbaseMaxThreads == rhs.atlasHookHbaseMaxThreads)||((this.atlasHookHbaseMaxThreads!= null)&&this.atlasHookHbaseMaxThreads.equals(rhs.atlasHookHbaseMaxThreads))))&&((this.phoenixFunctionsAllowUserDefinedFunctions == rhs.phoenixFunctionsAllowUserDefinedFunctions)||((this.phoenixFunctionsAllowUserDefinedFunctions!= null)&&this.phoenixFunctionsAllowUserDefinedFunctions.equals(rhs.phoenixFunctionsAllowUserDefinedFunctions))))&&((this.hbaseMasterHeapsize == rhs.hbaseMasterHeapsize)||((this.hbaseMasterHeapsize!= null)&&this.hbaseMasterHeapsize.equals(rhs.hbaseMasterHeapsize))))&&((this.securityClientProtocolAcl == rhs.securityClientProtocolAcl)||((this.securityClientProtocolAcl!= null)&&this.securityClientProtocolAcl.equals(rhs.securityClientProtocolAcl))))&&((this.atlasHookHbaseQueueSize == rhs.atlasHookHbaseQueueSize)||((this.atlasHookHbaseQueueSize!= null)&&this.atlasHookHbaseQueueSize.equals(rhs.atlasHookHbaseQueueSize))))&&((this.hbaseAtlasHook == rhs.hbaseAtlasHook)||((this.hbaseAtlasHook!= null)&&this.hbaseAtlasHook.equals(rhs.hbaseAtlasHook))))&&((this.hbaseBackupEnable == rhs.hbaseBackupEnable)||((this.hbaseBackupEnable!= null)&&this.hbaseBackupEnable.equals(rhs.hbaseBackupEnable))))&&((this.hbaseUserNofileLimit == rhs.hbaseUserNofileLimit)||((this.hbaseUserNofileLimit!= null)&&this.hbaseUserNofileLimit.equals(rhs.hbaseUserNofileLimit))))&&((this.hbaseDefaultsForVersionSkip == rhs.hbaseDefaultsForVersionSkip)||((this.hbaseDefaultsForVersionSkip!= null)&&this.hbaseDefaultsForVersionSkip.equals(rhs.hbaseDefaultsForVersionSkip))))&&((this.hbaseMasterPort == rhs.hbaseMasterPort)||((this.hbaseMasterPort!= null)&&this.hbaseMasterPort.equals(rhs.hbaseMasterPort))))&&((this.policyUser == rhs.policyUser)||((this.policyUser!= null)&&this.policyUser.equals(rhs.policyUser))))&&((this.hbaseRegionserverGlobalMemstoreSize == rhs.hbaseRegionserverGlobalMemstoreSize)||((this.hbaseRegionserverGlobalMemstoreSize!= null)&&this.hbaseRegionserverGlobalMemstoreSize.equals(rhs.hbaseRegionserverGlobalMemstoreSize))))&&((this.securityMasterregionProtocolAcl == rhs.securityMasterregionProtocolAcl)||((this.securityMasterregionProtocolAcl!= null)&&this.securityMasterregionProtocolAcl.equals(rhs.securityMasterregionProtocolAcl))))&&((this.zookeeperZnodeParent == rhs.zookeeperZnodeParent)||((this.zookeeperZnodeParent!= null)&&this.zookeeperZnodeParent.equals(rhs.zookeeperZnodeParent))))&&((this.hbaseClusterDistributed == rhs.hbaseClusterDistributed)||((this.hbaseClusterDistributed!= null)&&this.hbaseClusterDistributed.equals(rhs.hbaseClusterDistributed))))&&((this.hbaseHregionMemstoreBlockMultiplier == rhs.hbaseHregionMemstoreBlockMultiplier)||((this.hbaseHregionMemstoreBlockMultiplier!= null)&&this.hbaseHregionMemstoreBlockMultiplier.equals(rhs.hbaseHregionMemstoreBlockMultiplier))))&&((this.hbasePidDir == rhs.hbasePidDir)||((this.hbasePidDir!= null)&&this.hbasePidDir.equals(rhs.hbasePidDir))))&&((this.hbaseHregionMajorcompactionJitter == rhs.hbaseHregionMajorcompactionJitter)||((this.hbaseHregionMajorcompactionJitter!= null)&&this.hbaseHregionMajorcompactionJitter.equals(rhs.hbaseHregionMajorcompactionJitter))))&&((this.hbaseTmpDir == rhs.hbaseTmpDir)||((this.hbaseTmpDir!= null)&&this.hbaseTmpDir.equals(rhs.hbaseTmpDir))))&&((this.xasecureAuditDestinationHdfsDir == rhs.xasecureAuditDestinationHdfsDir)||((this.xasecureAuditDestinationHdfsDir!= null)&&this.xasecureAuditDestinationHdfsDir.equals(rhs.xasecureAuditDestinationHdfsDir))))&&((this.hbaseRpcTimeout == rhs.hbaseRpcTimeout)||((this.hbaseRpcTimeout!= null)&&this.hbaseRpcTimeout.equals(rhs.hbaseRpcTimeout))));
    }
