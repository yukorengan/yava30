package com.verzinen.ugm.model.jmx;
 ...
 public class NonHeapMemoryUsage {
     ...
     public String toString() {
         ...
         sb.append(NonHeapMemoryUsage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
         sb.append("committed");
         sb.append('=');
     ...
     public boolean equals(Object other) {
         ...
         if ((other instanceof NonHeapMemoryUsage) == false) {
             return false;
         }
         NonHeapMemoryUsage rhs = ((NonHeapMemoryUsage) other);
