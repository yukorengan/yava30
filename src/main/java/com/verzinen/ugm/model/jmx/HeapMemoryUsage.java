package com.verzinen.ugm.model.jmx;
 ...
 public class HeapMemoryUsage {
     ...
     public String toString() {
         ...
         sb.append(HeapMemoryUsage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
         sb.append("committed");
         sb.append('=');
     ...
     public boolean equals(Object other) {
         ...
         if ((other instanceof HeapMemoryUsage) == false) {
             return false;
         }
         HeapMemoryUsage rhs = ((HeapMemoryUsage) other);
