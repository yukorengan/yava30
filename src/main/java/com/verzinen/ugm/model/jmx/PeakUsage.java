package com.verzinen.ugm.model.jmx;
 ...
 public class PeakUsage {
     ...
     public String toString() {
         ...
         sb.append(PeakUsage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
         sb.append("committed");
         sb.append('=');
     ...
     public boolean equals(Object other) {
         ...
         if ((other instanceof PeakUsage) == false) {
             return false;
         }
         PeakUsage rhs = ((PeakUsage) other);
