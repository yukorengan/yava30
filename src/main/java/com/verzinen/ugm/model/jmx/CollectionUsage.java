package com.verzinen.ugm.model.jmx;
 ...
 public class CollectionUsage {
     ...
     public String toString() {
         ...
         sb.append(CollectionUsage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
         sb.append("committed");
         sb.append('=');
     ...
     public boolean equals(Object other) {
         ...
         if ((other instanceof CollectionUsage) == false) {
             return false;
         }
         CollectionUsage rhs = ((CollectionUsage) other);
